  ...
  return ( 
    <div className={styles.container} style={{width: `${width}px`}}>
      <div className={styles.multiBtn}>
        <a className={styles.overlay__btn} href={props.project.gitLink} target="_blank" rel="noopener noreferrer"><i className="fab fa-github"></i></a>
        <a className={styles.overlay__btn} href={props.project.liveLink} target="_blank" rel="noopener noreferrer">Visit!</a>
        <button className={styles.overlay__btn} onClick={(e)=>handleClick(e)}><i className="fas fa-ellipsis-h"></i></button>
      </div>
